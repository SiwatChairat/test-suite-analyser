...
public class App {
    ...
    public static void run() throws IOException {
        ...
        if (a.toLowerCase().compareTo("y") == 0) {
            ...
            System.out.println("How many repetitions you would like to run? [0-5]");
            String rep = askInput();

            AppCompile c = new AppCompile("lottie-android", head, Integer.parseInt(rep));
